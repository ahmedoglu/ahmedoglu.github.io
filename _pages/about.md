---
layout: home
title: Mümin Ahmedoğlu
permalink: /
redirect_from:
  - /about/
  - /about.html
# The page text below: the first paragraph appears next to the photo; each
# "###" block after it becomes one column of the About section.
#
# The short list shown under "Research interests" on the home page
interests:
  - Defense economics
  - Market design
  - Defense procurement
  ...
  - Causal inference
  - Text as data
# Third-person bio for conference programs and introductions (shown in a
# collapsible box with a copy button under the buttons on the home page)
bio_third_person: >-
...
I came to research from inside the defense industry. Trained as an industrial engineer at Middle East Technical University, I worked in the R&D project management office for the Bayraktar TB2 and AKINCI unmanned aerial vehicles at Baykar, then managed tactical mini-UAV projects at STM. I studied management and technology at the Technical University of Munich, worked in strategy roles at Siemens and Allianz, and joined the ERC-funded SYNCPOL project at LMU Munich. That path shapes my research: I pair causal inference and text-as-data methods with a practical sense of how defense programs are specified, contracted, and delivered.

### Talks, writing, and teaching

My research has appeared in *New Perspectives*, and I have presented it at the International Conference on Economics and Security, the Swedish Defence University, and Masaryk University. I write *Defense Economics Notes*, a newsletter on defense economics and industrial capacity, and I teach Human Resource Management at the University of Vienna. I work in English, Turkish, and Arabic, and I am learning German.
